...
const EditBooks = () => {
  ...
  return (
    <div className='px-4 my-12'>
        ...
        <TextInput id="bookTitle" name="bookTitle" placeholder="Book Name" 
        type="text"defaultValue={bookTitle} required />
      </div>
 ...
 {/*second row */}
        ...
        <TextInput id="imageURL" name="imageURL" placeholder="Book Image" type="text" defaultValue={imageURL} required />
      </div>
